...
router.get("/introduction/:id" ,authorization,   async (req, res) => {
    ...
    try { 
        ...
        if (COUNSELLEEID) {
          ...
          res.status(200).json( {details : newCounsellorName.rows[0],
...
router.get("/info/:id" ,authorization,   async (req, res) => {
    ...
    try {
        // var user =      { COUNSELLEE_FIRST_NAME,
        //     COUNSELLEE_LAST_NAME,
        //     COUNSELLEE_EMAIL,COUNSELLEE_FILES,
        //     COUNSELLEE_PHONE_NUMBER,
        //     COUNSELLEE_COUNTRY_CODE, 
        //     COUNSELLEE_QUALIFICATION_INSTITUTE, 
        //     COUNSELLEE_PHOTO, COUNSELLEE_HEADLINE, COUNSELLEE_ABOUT_DESCRIPTION,
        ...
        if (COUNSELLEEID) {
          ...
          res.status(200).json( {  Details :newCounsellorDetails.rows  , Introduction :newCounsellorIntroductionDetails.rows,
