    ...
    try {
        ...
        if (user.rows.length == 1 && uploadtoS3) {
            ...
            const newCounsellorDetails = await pool.query(
                'INSERT INTO "CT_COUNSELLOR_DETAILS" ("CT_EMAIL", "CT_FIRST_NAME", "CT_LAST_NAME", "CT_PHONE_NUMBER", "CT_COUNTRY_CODE", "CT_COUNSELLOR_ID","CT_COUNSELLOR_VERIFY","CT_COUNSELLOR_VERIFIED") VALUES($1,$2,$3,$4,$5,$6,$7,$8) RETURNING *',
                [COUNSELLOR_EMAIL, COUNSELLOR_FIRST_NAME, COUNSELLOR_LAST_NAME, COUNSELLOR_PHONE_NUMBER, COUNSELLOR_COUNTRY_CODE, COUNSELLORID, filestring.toString(),0]);
