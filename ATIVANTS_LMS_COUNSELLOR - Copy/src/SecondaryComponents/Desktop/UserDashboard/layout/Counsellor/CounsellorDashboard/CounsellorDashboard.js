...
import ViewRequest from "../CounsellorPages/ViewCounsellorRequest";
import ViewCounsellorProfile from "../CounsellorPages/ViewCounsellorProfile";

import ViewMessages from "../../SharedComponents/ViewMessages";
import ViewAccepted from "../CounsellorPages/ViewCounsellorAccepted";
import ViewDeclined from "../CounsellorPages/ViewCounsellorDeclined";

import ViewNoti from "../../SharedComponents/ViewNoti";
import ViewCounsellorChangeRequest from "../CounsellorPages/ViewCounsellorChangeRequest";

import ViewCounsellorEdit from "../CounsellorPages/ViewCounsellorEdit";
...
const CounsellorDashboard = (props) => {
  ...
  const [isViewChangeSelected, setViewChangeSelected] = useState(true);
