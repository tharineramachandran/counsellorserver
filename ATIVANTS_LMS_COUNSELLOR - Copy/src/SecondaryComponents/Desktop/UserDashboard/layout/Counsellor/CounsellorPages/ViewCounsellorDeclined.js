...
class ViewDeclined extends React.Component {
  ...
  setTabledata = () => {
    axios
      .get(baseURLAPI + "/session/counsellor/declined", {
        headers: {
          jwtToken: localStorage.jwtToken,
        },
        data: {
      ...
      .then((res) => {
        ...
        var loading = false;
        this.setState({ requests , loading});
      })
      .catch(function (error) {
        console.log(error);
      });
                    ...
                    this.state.requests.map((person, index) => (
                      <div style={{ paddingTop: "1%", paddingBottom: "1%" }}>
                        ...
                        <div style={{ width: "80%", margin: "auto" }}>
                          <Card style={{ width: "100%" }}>
                            <div>
                              ...
                              >
                                ...
                                <Button
                          color="green"
                            onClick={() => this.acceptRequest(person.id, 1)}
                          >
                          ...
                          <Button
                           color="red"
                            onClick={() => this.acceptRequest(person.id, 4)}
                          >
