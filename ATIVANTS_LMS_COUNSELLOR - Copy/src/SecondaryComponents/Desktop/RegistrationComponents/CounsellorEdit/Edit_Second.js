...
const Edit_Second = ({ formData, setForm, navigation, step }) => {
    ...
    useEffect(() => {
        ...
        axios.get(baseURLAPI + '/Counsellor/profilePicture/' + localStorage.userID, {
            headers: {
    ...
    const _handleSubmitClick = async () => {
        ...
        axios.post(baseURLAPI + '/Counsellor/UpdatePhoto', { formData: formData, COUNSELLORID: localStorage.userID },
