...
var getFieldsValues = (function (fieldsRef, unmountFieldsStateRef, excludeDisabled, search) {
    var output = {};
    ...
    return deepMerge(__assign({}, ((unmountFieldsStateRef || {}).current || {})), transformToNestObject(output));
});
...
function useForm(_a) {
        ...
        if (isArray(payload)) {
            ...
            try {
                for (var payload_1 = __values(payload), payload_1_1 = payload_1.next(); !payload_1_1.done; payload_1_1 = payload_1.next()) {
                    ...
                    set(data, name_1, getFieldValue(fieldsRef, name_1, unmountFieldsStateRef));
                }
            }
            catch (e_1_1) { e_1 = { error: e_1_1 }; }
            finally {
    ...
    function clearErrors(name, config) {
        if (config === void 0) { config = { exact: true }; }
        name &&
            (isArray(name) ? name : [name]).forEach(function (inputName) {
                return (fieldsRef.current[inputName] || !config.exact) &&
    ...
    function setError(name, error) {
        ...
        set(formStateRef.current.errors, name, __assign(__assign({}, error), { ref: (fieldsRef.current[name] || {}).ref }));
        updateFormState({
            isValid: false,
            errors: formStateRef.current.errors,
        });
